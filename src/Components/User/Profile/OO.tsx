        ...
        <>
            ...
            <div >
                ...
                <div className="min-h-screen grid top-20 relative items-center justify-center  ">
                    ...
                    <div className=' md:right-0    w-[904px ]   -z-0 left-1  right-0 relative    md:mx-44 md:left-28 lg:mx-72 xl:mx-2 xl:ml-6 xl:max-w-[100%] max-w-3xl:w-[100%] lg:right-0 border-1 shadow-md shadow-gray-600'>
                    ...
                    <div
                        className="w-full  left-28  flex flex-wrap relative  rounded-sm overflow-auto ">
                        ...
                        <div className=" w-full  relative items-center mt-5 justify-center  ">
