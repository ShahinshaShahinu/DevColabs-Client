...
// import JoditEditor  from "jodit-react-ts"; // Import IJodit interface
...
//       <JoditEditor
//         config={config}
//         onChange={(newContent: string) => getValue(newContent)}
//         // defaultValue={content} // Use 'value' instead of 'onChange' to control the editor content
//       />
//     </div>
//   );
// }
...
function JoditPostCreation({ initialValue, getValue  }: RichTextEditorProps) {
  ...
  return (
    <div style={{ maxWidth: '881px', margin: 'auto', border: '1px solid #ccc', borderRadius: '10px', height: '310px', overflowY: 'auto' }}>
