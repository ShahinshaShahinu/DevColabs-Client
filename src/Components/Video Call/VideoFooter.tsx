            ...
            <div className="md:hidden">
              <div className="flex space-x-4">
                <a className="hover:text-gray-400">
                  <AiFillHome className='text-2xl mx-5 cursor-pointer' onClick={() => { Navigate('/') }} />
                </a>
                <a className="hover:text-gray-400">
                  <HiOutlineUserGroup className='text-2xl mx-5 cursor-pointer' onClick={() => { Navigate('/Community') }} />
                </a>
              </div>
            </div>
