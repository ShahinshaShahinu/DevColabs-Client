...
console.log(pathnameWithoutAdmin,'pppppppppppp');
   ...
   const AdminCircleButton = () => {
      setShowAdminCircle(!ShowAdminCircle)
   }
   const SidebarX = () => {
      setChangeBrn(!ChangeBtn)
   ...
   return (
      <div>
         ...
         <nav className="fixed top-0 z-50 w-full bg-white border-b bg border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
               <div className="flex items-center justify-between">
                  <div className="flex items-center justify-start">
                     <button onClick={SidebarX} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                     ...
                     <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                        ...
                        <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">DevColab</span>
                     </a>


                     {ChangeBtn ? (
                        <GoSidebarCollapse onClick={SidebarX} className='cursor-pointer text-white hidden md:block text-3xl' />
                     ) : (<GoSidebarExpand onClick={SidebarX} className='cursor-pointer text-white hidden md:block text-3xl' />)}

                  </div>
                  <div className="flex items-center">
                     <div className="flex items-center ml-3">
                        <div>
                           <button onClick={AdminCircleButton} type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                              <span className="sr-only">Open user menu</span>
                              <img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo" />
                           </button>
                        </div>
                        {ShowAdminCircle && (
                           <div className="absolute z-[-1] top-9 mt-4  right-0 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" >
                  ...
                  <ul className="space-y-2 font-medium">
                     ...
                     >
                        ...
                        >
                           ...
                           <span className="ml-3 text-cyan-100">Dashboard</span>
                        </a>
                     </li>
